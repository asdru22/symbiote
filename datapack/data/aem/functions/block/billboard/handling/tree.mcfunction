summon armor_stand ~ ~ ~ {Tags:["aem.billboard","aem.display","aem.setup"],Small:1b,Marker:1b,Invisible:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:quartz",Count:1b,tag:{CustomModelData:6901000,aem:{click:"test",cmd:6901001}}}]}
