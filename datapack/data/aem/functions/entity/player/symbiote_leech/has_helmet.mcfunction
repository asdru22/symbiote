### Custom Model Data
execute if entity @s[scores={aem.symbiote_id=1}] run scoreboard players set .cmd aem.data 6900999
execute if entity @s[scores={aem.symbiote_id=2}] run scoreboard players set .cmd aem.data 6901003
