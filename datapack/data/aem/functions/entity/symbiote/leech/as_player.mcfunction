...
execute unless score @s aem.max_symbiotes matches 1.. run function aem:entity/symbiote/leech/set_max

execute if score @s aem.symbiote > @s aem.max_symbiotes run function aem:entity/player/has_max_symbiotes
