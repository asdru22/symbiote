summon armor_stand ~ ~-0.5 ~ {Marker:1b,Invisible:1b,Tags:["asy.entity","asy.block","asy.block.billboard","asy.setup"],ArmorItems:[{},{},{},{id:"minecraft:furnace",Count:1b,tag:{CustomModelData:6901000}}]}
