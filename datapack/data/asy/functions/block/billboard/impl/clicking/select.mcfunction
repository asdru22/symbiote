...
execute as @e[type=marker,tag=asy.billboard.center] if score @s asy.id = .temp asy.data at @s run summon armor_stand ~ ~-0.5 ~ {Invisible:1b,Marker:1b,Invulnerable:1b,NoGravity:1b,Tags:["asy.billboard","asy.billboard.display","asy.setup"],ArmorItems:[{},{},{},{id:"minecraft:redstone",Count:1b}]}
