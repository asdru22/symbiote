...
execute unless data entity @s Inventory[{Slot:103b}].Count run item replace entity @s armor.head with recovery_compass{CustomModelData:6901000,Enchantments:[{id:"minecraft:binding_curse",lvl:1s},{id:"minecraft:vanishing_curse",lvl:1s}],HideFlags:127,asb:{scraper_marker:1b},display:{Name:'{"translate":"entity.asb.scraper.draning","color": "red","italic": false}',Lore: ['{"translate": "entity.asb.scraper.shake","color":"white","italic": false}']}} 